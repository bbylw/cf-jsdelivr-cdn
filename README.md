...
<!-- JS (SVG) -->
<script src="https://cdn.yourdomain.com/npm/@fortawesome/fontawesome-free@7.1.0/js/all.min.js"></script>
```
...
2. **部署**:
   ...
   - **关键步骤**: 在“构建配置 (Build configuration)”中，将 **构建输出目录 (Build output directory)** 设置为 `pages`。
   - 或者，如果你是直接上传，请上传 `pages` 文件夹内的内容（确保 `_worker.js` 在根目录）。
